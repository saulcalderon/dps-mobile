  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        {data?.map((item) => (
          <Card key={item.id} text={`${formatDate(item.date)} - ${item.time} - ${item.patientName}`}
            onPress={() => navigation.navigate('Detalle-Cita', { appointment: item })}
          />
        ))}
      </View>
